...
s=re.sub(r"<script>\n// every script is stamped.*?</script>", '<script src="game/arcade.js"></script><script src="game/italy.js"></script><script src="game/piazza.js"></script><script src="game/bouquet.js"></script><script src="game/flight.js"></script><script src="game/seating.js"></script><script type="module" src="gallery3d.js"></script>', s, flags=re.S)
