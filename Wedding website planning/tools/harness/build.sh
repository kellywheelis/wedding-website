...
sed -e 's#</head>#<style>\#gate,\#label,\#nav,\#motto{display:none !important}</style><script>window.addEventListener("error",function(e){var d=document.createElement("pre");d.style.cssText="position:fixed;left:0;top:0;z-index:999;background:\#000;color:\#f66;font:13px monospace;padding:6px;white-space:pre-wrap";d.textContent="ERROR "+e.message+" @ "+e.filename+":"+e.lineno;document.body.appendChild(d)})</script></head>#' -e 's#gallery3d.js?v=[0-9]*#gallery3d.js#' "$P/The Gallery 3D.html" > "$W/index.html"
